package net.forexample.startcommand.world;
...
import net.forexample.startcommand.world.gen.ModStructureGeneration;
import net.forexample.startcommand.world.structure.ModStructures;
import java.lang.reflect.Method;
import java.util.HashMap;
import java.util.Map;

@Mod.EventBusSubscriber(modid = CommandMod.MOD_ID)
